...
<tr>
	<td align="center" colspan="13">
		<h2>Okeechobee Job List&nbsp;<i><%=df.format(ddate) %></i></h3>
	</td>
</tr>

<tr>
	<th width="14%" class="header" >ALLEN PATTERSON<br/></th>
	<th width="5" bgcolor="#000000"></th>
    <th width="14%" class="header"></th> 
    <th width="5" bgcolor="#000000"></th>
    <th width="14%" class="header">ALLEN PATTERSON</th>
    <th width="5" bgcolor="#000000"></th>
    <th width="14%" class="header">ALLEN PATTERSON</br></th>
    <th width="5" bgcolor="#000000"></th>
    <th width="14%" class="header">ALLEN PATTERSON</br></th>
            ...
            <tr>
            	<td class="student">
            		<logic:iterate id="loop" name="reportForm" property="courierList">
                     ...
                     <tr>
            	<td class="department">
            		<b>DTC Houseman(<bean:write name="reportForm" property="dtcHousemanListSize" />)</b> 
                </td> 
            </tr>
            <tr>
            	<td class="student">
           ...
           <tr>
            ...
            <tr>
  			...
  			<tr><td height="10"></td></tr>
			           ...
			           <tr>
            	<td class="department">
            		<b>Dairy Calves(<bean:write name="reportForm" property="dairyListSize" />)</b>
                </td>
            </tr>
            <tr>
            	<td class="student">
            		<logic:iterate id="loop" name="reportForm" property="dairyList">
                		<bean:write name="loop" property="firstname" />&nbsp;<bean:write name="loop" property="lastname" /><br/>
                   	</logic:iterate>
                </td>
            </tr>
